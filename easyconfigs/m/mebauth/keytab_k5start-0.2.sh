...
# Avoid interference from libraries loaded by other modules 
# (fixes https://meb-ki.atlassian.net/browse/ITSUPP-37290,
# error messages like "Regex version mismatch, expected: 
# 10.42 2022-12-11 actual: 10.40 2022-04-14" after loading
# e.g. R (really PCRE2))
